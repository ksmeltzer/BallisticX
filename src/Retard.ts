 ...
 * 
 * @param {DragFunction} dragFunction
 * @param {number} dragCoefficient The coefficient of drag for the projectile for the given drag function.
 * @param {number} velocity The velocity of the projectile.
 * 
 * @returns {number} The projectile drag retardation velocity, in ft/s per second
 */
export function calculateRetard(
    ...
    switch (dragFunction) {
        ...
        default:
            throw new Error("Invalid DragFunction");
    }
